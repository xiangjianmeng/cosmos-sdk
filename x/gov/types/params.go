...
func ParamKeyTable() paramtypes.KeyTable {
	return paramtypes.NewKeyTable(
		...
		paramtypes.NewParamSetPair(ParamStoreKeyTendermintParams, TendermintParams{}, nil),
	)
}

// DepositParams defines the params around deposits for governance
type DepositParams struct {
	MinDeposit       sdk.DecCoins     `json:"min_deposit,omitempty" yaml:"min_deposit,omitempty"`               //  Minimum deposit for a proposal to enter voting period.
...
func NewDepositParams(minDeposit sdk.DecCoins, maxDepositPeriod time.Duration) DepositParams {
...
func DefaultDepositParams() DepositParams {
	return NewDepositParams(
		sdk.NewDecCoins(sdk.NewDecCoin(sdk.DefaultBondDenom, DefaultMinDepositTokens)),
		DefaultPeriod,
	)
}
